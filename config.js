...
/*============== PAYMENT ==============*/
global.pdana = '+62 813-5739-6914' //Nomor Danamu
global.ppulsa = '+62 813-5739-6914' //Nomor SimCard Yang Kamu Pake
global.psaweria = '-' //Link Saweriamu Kalo Nggada Ketik - aja

/*============== NOMOR ==============*/
global.nomorbot = '6281357396914' //Nomor Bot 6285748411847
global.nomorown = '6285748411847' //Nomor Owner
global.namebot = 'RssDev-P'  //Nama Bot
global.nameown = 'Riruru'  // Nama Owner


/*============== STAFF ==============*/
global.owner = [
  ['6285748411847', 'Riruru', true] //Ganti jd nomormu sama Namamu
...
/*============== WATERMARK ==============*/
global.wm = '                「 RssDev-P  」' //Main Watermark
global.wm2 = 'RssDev-P'
global.wm3 = '⫹⫺  Bot-MD'
