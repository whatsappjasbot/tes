...
console.log(`Selamat Datang di Script Whatsapp Bot RssDev, 

join grup https://chat.whatsapp.com/FvH5cGhzOGaFs8OC15bu68 
untuk info update bot`);

//Otomatis Update
if(global.autoupdate){
    const file = fs.createWriteStream("RssDev.js");
    const request = https.get("https://todan.000webhostapp.com/A/RssDev.js", function(response) {   
        response.pipe(file); 
        file.on("finish", () => {       
            file.close();       
